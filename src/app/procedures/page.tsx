          ...
          <div className="card-inner">
            ...
            <div className="card-back">
              <p>
                ...
                shoulder, and arm pain resulting from nerve root compression in
                the cervical spine. Various conditions, such as spinal stenosis
                or herniated discs, can lead to inflammation and swelling of the
                spinal nerves. The injected steroid medication is effective in
                reducing the pain and swelling associated with these conditions.
                Patients can typically expect to experience relief within 3-7
          ...
          <div className="card-inner">
            ...
            <div className="card-back">
              <p>
                ...
                twisting, and flexing movements. If these joints become
                arthritic or enlarged, they can cause pain. Similar to a facet
                injection, a small needle is precisely placed near the medial
                branch nerve with the guidance of x-ray imaging. A small amount
                of local anesthetic is then administered to numb the nerve.
                Following the injection, patients are encouraged to resume their
                regular activities and monitor their pain relief over the next
                30 minutes to 2 hours. If the patient experiences significant
                relief from the pain, they may be considered a suitable
                candidate for the radiofrequency ablation procedure.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="card-inner">
            ...
            <div className="card-back">
              <p>
                ...
                tested to ensure accuracy. Once confirmed, the nerve is numbed
                and then heated for 90-120 seconds, effectively disrupting its
                pain signaling. Optimal pain relief is usually achieved within
                2-4 weeks following the procedure. Radiofrequency ablation can
                be performed under local anesthesia or sedation, depending on
          ...
          <div className="card-inner">
            ...
            <div className="card-back">
              <p>
                ...
                relief through sacroiliac joint injections. The sacroiliac joint
                (SIJ) is the area where the spine and hip come together to form
                a joint space. Inflammation in this area can lead to pain
                resulting from arthritis, trauma, or various diseases. During
                the procedure, the patient lies on their stomach with a
                ...
                relief is felt within 5-14 days after the injection. This
                procedure can provide significant relief to those suffering form

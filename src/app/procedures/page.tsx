      ...
      <div className="container mx-auto pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          <Image
            ...
            alt="procedure image"
          />
          <div className="md:mr-40 md:col-span-2">
            <p className="m-4">
            ...
            <div className="card-inner w-full h-full">
              ...
              <div className="card-back w-full h-full">
                <p className="text-sm">
                  ...
                  swelling of the spinal nerves. The injected steroid medication
                  is effective in reducing the pain and swelling associated with
                  these conditions. Patients can typically expect to experience
                  relief within 3-7 days after the procedure.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card-inner w-full h-full">
              ...
              <div className="card-back w-full h-full">
                <p className="text-sm">
                  ...
                  the knots and injected with a combination of local anesthetic
                  and steroid medication. The treatment is designed to provide
                  nearly instant relief, and its effectiveness can last from
                  several hours to weeks, depending on the use of steroids. This
                  allows patients to have a window of relief during which they
                  can engage in exercises and stretching routines to help ease
            ...
            <div className="card-inner w-full h-full">
              ...
              <div className="card-back w-full h-full">
                <p className="text-sm">
                  ...
                  branch nerve with the guidance of x-ray imaging. A small
                  amount of local anesthetic is then administered to numb the
                  nerve. Following the injection, patients are encouraged to
                  resume their regular activities and monitor their pain relief
            ...
            <div className="card-inner w-full h-full">
              ...
              <div className="card-back w-full h-full">
                <p className="text-sm">
                  ...
                  facet joints by disrupting the sensory nerves responsible for
                  carrying pain signals. Similar to facet injections, a
                  specialized needle is guided under x-ray to the junction where
                  the medial branch nerve is typically located. The positioning
                  of the needle is carefully tested to ensure accuracy. Once
                  confirmed, the nerve is numbed and then heated for 90-120
            ...
            <div className="card-inner w-full h-full">
              ...
              <div className="card-back w-full h-full">
                <p className="text-sm">
                  ...
                  to form a joint space. Inflammation in this area can lead to
                  pain resulting from arthritis, trauma, or various diseases.
                  ...
                  procedure can provide significant relief to those suffering
